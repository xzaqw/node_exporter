...
func (e *GZZpoolListCollector) zpoolIostatLatenciesQueues() error {
	...
	if eerr != nil {
		...
		perr := e.parseZpoolIostatLatenciesQueuesOutput(out)
		if perr != nil {
...
func (e *GZZpoolListCollector) parseZpoolIostatLatenciesQueuesOutput(out []byte) error {
	...
	for scanner.Scan() {
		...
		*/
		...
		err = e.helperZpoolWithSet(pool, vdev, e.gzZpoolListCapacityAlloc, parsedLine[1], 1)
		if err != nil {
			return err
		}
		err = e.helperZpoolWithSet(pool, vdev, e.gzZpoolListCapacityFree, parsedLine[2], 1)
		if err != nil {
			return err
		}
		err = e.helperZpoolWithSet(pool, vdev, e.gzZpoolListOperationsRead, parsedLine[3], 1)
		if err != nil {
			return err
		}
		err = e.helperZpoolWithSet(pool, vdev, e.gzZpoolListOperationsWrite, parsedLine[4], 1)
		if err != nil {
			return err
		}
		err = e.helperZpoolWithSet(pool, vdev, e.gzZpoolListBandwidthRead, parsedLine[5], 1)
		if err != nil {
			return err
		}
		err = e.helperZpoolWithSet(pool, vdev, e.gzZpoolListBandWidthWrite, parsedLine[6], 1)
		if err != nil {
			return err
		}
		err = e.helperZpoolWithSet(pool, vdev, e.gzZpoolListTotalWaitRead, parsedLine[7], NSEC_TO_SEC_FACTOR)
		if err != nil {
			return err
		}
		err = e.helperZpoolWithSet(pool, vdev, e.gzZpoolListTotalWaitWrite, parsedLine[8], NSEC_TO_SEC_FACTOR)
		if err != nil {
			return err
		}
		err = e.helperZpoolWithSet(pool, vdev, e.gzZpoolListDiskRead, parsedLine[9], NSEC_TO_SEC_FACTOR)
		if err != nil {
			return err
		}
		err = e.helperZpoolWithSet(pool, vdev, e.gzZpoolListDiskWrite, parsedLine[10], NSEC_TO_SEC_FACTOR)
		if err != nil {
			return err
		}
		err = e.helperZpoolWithSet(pool, vdev, e.gzZpoolListSyncWaitRead, parsedLine[11], NSEC_TO_SEC_FACTOR)
		if err != nil {
			return err
		}
		err = e.helperZpoolWithSet(pool, vdev, e.gzZpoolListSyncWaitWrite, parsedLine[12], NSEC_TO_SEC_FACTOR)
		if err != nil {
			return err
		}
		err = e.helperZpoolWithSet(pool, vdev, e.gzZpoolListAsyncWaitRead, parsedLine[13], NSEC_TO_SEC_FACTOR)
		if err != nil {
			return err
		}
		err = e.helperZpoolWithSet(pool, vdev, e.gzZpoolListAsyncWaitWrite, parsedLine[14], NSEC_TO_SEC_FACTOR)
		if err != nil {
			return err
		}
		err = e.helperZpoolWithSet(pool, vdev, e.gzZpoolListScrubWait, parsedLine[15], NSEC_TO_SEC_FACTOR)
		if err != nil {
			return err
		}
		err = e.helperZpoolWithSet(pool, vdev, e.gzZpoolListTrimWait, parsedLine[16], NSEC_TO_SEC_FACTOR)
		if err != nil {
			return err
		}
		err = e.helperZpoolWithSet(pool, vdev, e.gzZpoolListSyncqReadPend, parsedLine[17], 1)
		if err != nil {
			return err
		}
		err = e.helperZpoolWithSet(pool, vdev, e.gzZpoolListSyncqReadActiv, parsedLine[18], 1)
		if err != nil {
			return err
		}
		err = e.helperZpoolWithSet(pool, vdev, e.gzZpoolListSyncqWritePend, parsedLine[19], 1)
		if err != nil {
			return err
		}
		err = e.helperZpoolWithSet(pool, vdev, e.gzZpoolListSyncqWriteActiv, parsedLine[20], 1)
		if err != nil {
			return err
		}
		err = e.helperZpoolWithSet(pool, vdev, e.gzZpoolListAsyncqReadPend, parsedLine[21], 1)
		if err != nil {
			return err
		}
		err = e.helperZpoolWithSet(pool, vdev, e.gzZpoolListAsyncqReadActiv, parsedLine[22], 1)
		if err != nil {
			return err
		}
		err = e.helperZpoolWithSet(pool, vdev, e.gzZpoolListAsyncqWritePend, parsedLine[23], 1)
		if err != nil {
			return err
		}
		err = e.helperZpoolWithSet(pool, vdev, e.gzZpoolListAsyncqWriteActiv, parsedLine[24], 1)
		if err != nil {
			return err
		}
		err = e.helperZpoolWithSet(pool, vdev, e.gzZpoolListScrubqReadPend, parsedLine[25], 1)
		if err != nil {
			return err
		}
		err = e.helperZpoolWithSet(pool, vdev, e.gzZpoolListScrubqReadActiv, parsedLine[26], 1)
		if err != nil {
			return err
		}
		err = e.helperZpoolWithSet(pool, vdev, e.gzZpoolListTrimqWritePend, parsedLine[27], 1)
		if err != nil {
			return err
		}
		err = e.helperZpoolWithSet(pool, vdev, e.gzZpoolListTrimqWriteActiv, parsedLine[28], 1)
		if err != nil {
			return err
		}
	}
	...
	if err := scanner.Err(); err != nil {
		return fmt.Errorf("reading zpool iostat latencies queues output: %w", err)
	}

	return nil
}

func trimPrefixLines(b []byte, count uint64) []byte {
	i := 0
	for newlineCount := uint64(0); newlineCount < count; {
		if b[i] == 0x0a {
			newlineCount++
		}
		i++
